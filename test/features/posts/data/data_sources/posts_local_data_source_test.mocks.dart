...
// in unit_testing/test/features/posts/data/data_sources/posts_local_data_source_test.dart.
...
import 'package:unit_testing/features/posts/data/data_sources/posts_local_data_source.dart'
    as _i2;
import 'package:unit_testing/features/posts/data/models/post_model.dart' as _i4;
...
class MockPostsLocalDataSource extends _i1.Mock
    implements _i2.PostsLocalDataSource {
  @override
  ...
  @override
  _i3.Future<bool> cachingPosts({required List<_i4.PostModel>? posts}) =>
      (super.noSuchMethod(
        Invocation.method(
          #cachingPosts,
          [],
